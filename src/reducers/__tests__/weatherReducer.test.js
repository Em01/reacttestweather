...
describe('Weather Reducer',() => {
  ...
  describe('UPDATE_WEATHER', () => {
    ...
    it('handles updateWeather', () => {
      expect(result).toEqual({loadingWeather: false, weatherData: weatherData, loadedWeather: true})
    })
  })
  ...
  describe('GET_WEATHER_FAILED', () => {
    ...
    it('handles updateCity', () => {
      expect(result).toEqual({error: error, weatherFetchState: 'FAILED', loadingWeather: false })
    })
  })
})
